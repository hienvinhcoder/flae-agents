# React frontend behavior acceptance checklist

These stable IDs record the final cutover acceptance contract. Tests may be component, integration, or end-to-end tests, but each ID remains independently reportable. Unless stated otherwise, all backend calls use the contracts in `api-contracts.md` and all authenticated routes render in the dashboard layout. Angular comparisons below are retained only where they explain a parity or hardening decision.

## Automated evidence matrix

All 74 stable IDs below are decided and checked. Evidence labels are precise: E2E identifies the deterministic browser specification for the real React route and production adapter; integration/unit identifies the linked Vitest evidence for the named route, component, hook, transport, or schema directly. Evidence now lives with the supported application under `frontend/`; this documentation update does not claim a fresh execution of every linked suite.

| Stable IDs | Evidence level | Automated evidence |
| --- | --- | --- |
| ROUTE-01–ROUTE-03, ROUTE-07 | Integration | [`router.test.tsx`](../../../frontend/src/app/router/router.test.tsx), [`ProtectedRoute.test.tsx`](../../../frontend/src/core/auth/ProtectedRoute.test.tsx), [`GuestRoute.test.tsx`](../../../frontend/src/core/auth/GuestRoute.test.tsx), [`RouteErrorBoundary.test.tsx`](../../../frontend/src/app/errors/RouteErrorBoundary.test.tsx) |
| ROUTE-04–ROUTE-06 | Integration | [`supporting-pages.test.tsx`](../../../frontend/src/features/supporting-pages.test.tsx) |
| AUTH-01–AUTH-06, AUTH-02A, AUTH-02B | E2E plus integration/unit | [`auth.spec.ts`](../../../frontend/tests/e2e/auth.spec.ts), [`AuthBootstrap.test.tsx`](../../../frontend/src/core/auth/AuthBootstrap.test.tsx), [`AuthBootstrap.registration.test.tsx`](../../../frontend/src/core/auth/AuthBootstrap.registration.test.tsx), [`AuthBootstrap.e2e.test.tsx`](../../../frontend/src/core/auth/AuthBootstrap.e2e.test.tsx), [`LoginPage.test.tsx`](../../../frontend/src/features/auth/pages/LoginPage.test.tsx), [`RegisterPage.test.tsx`](../../../frontend/src/features/auth/pages/RegisterPage.test.tsx), [`useLogout.test.tsx`](../../../frontend/src/core/auth/useLogout.test.tsx) |
| WS-01–WS-08, WS-05A–WS-05C | E2E plus integration/unit | [`workspace.spec.ts`](../../../frontend/tests/e2e/workspace.spec.ts), [`AppShell.test.tsx`](../../../frontend/src/app/layout/AppShell.test.tsx), [`use-workspaces.test.tsx`](../../../frontend/src/features/settings/hooks/use-workspaces.test.tsx), [`SettingsPage.test.tsx`](../../../frontend/src/features/settings/pages/SettingsPage.test.tsx), [`InviteAcceptPage.test.tsx`](../../../frontend/src/features/invite/pages/InviteAcceptPage.test.tsx), [`workspace-api.test.ts`](../../../frontend/src/features/settings/api/workspace-api.test.ts) |
| KB-01–KB-09 | E2E plus integration/unit | [`knowledge.spec.ts`](../../../frontend/tests/e2e/knowledge.spec.ts), [`KnowledgeListPage.test.tsx`](../../../frontend/src/features/knowledge/pages/KnowledgeListPage.test.tsx), [`use-knowledge.test.tsx`](../../../frontend/src/features/knowledge/hooks/use-knowledge.test.tsx), [`knowledge-api.test.ts`](../../../frontend/src/features/knowledge/api/knowledge-api.test.ts), [`knowledge-schema.test.ts`](../../../frontend/src/features/knowledge/schemas/knowledge-schema.test.ts) |
| TOPIC-01–TOPIC-07 | E2E plus integration/unit | [`topics.spec.ts`](../../../frontend/tests/e2e/topics.spec.ts), [`TopicListPage.test.tsx`](../../../frontend/src/features/topics/pages/TopicListPage.test.tsx), [`TopicDetailPage.test.tsx`](../../../frontend/src/features/topics/pages/TopicDetailPage.test.tsx), [`use-topics.test.tsx`](../../../frontend/src/features/topics/hooks/use-topics.test.tsx), [`topics-api.test.ts`](../../../frontend/src/features/topics/api/topics-api.test.ts) |
| AGENT-01–AGENT-07 | E2E plus integration/unit | [`agents.spec.ts`](../../../frontend/tests/e2e/agents.spec.ts), [`AgentListPage.test.tsx`](../../../frontend/src/features/agents/pages/AgentListPage.test.tsx), [`AgentConfigPage.test.tsx`](../../../frontend/src/features/agents/pages/AgentConfigPage.test.tsx), [`AgentChatPage.test.tsx`](../../../frontend/src/features/agents/pages/AgentChatPage.test.tsx), [`use-agents.test.tsx`](../../../frontend/src/features/agents/hooks/use-agents.test.tsx), [`agents-api.test.ts`](../../../frontend/src/features/agents/api/agents-api.test.ts) |
| CHAT-01–CHAT-07, CHAT-05A–CHAT-05C | E2E plus integration/unit | [`chat.spec.ts`](../../../frontend/tests/e2e/chat.spec.ts), [`AgentChatPage.test.tsx`](../../../frontend/src/features/agents/pages/AgentChatPage.test.tsx), [`use-chat-stream.test.tsx`](../../../frontend/src/features/chat/hooks/use-chat-stream.test.tsx), [`ConversationMessages.test.tsx`](../../../frontend/src/features/chat/ui/ConversationMessages.test.tsx), [`sse.test.ts`](../../../frontend/src/core/realtime/sse.test.ts), [`stream.test.ts`](../../../frontend/src/features/chat/types/stream.test.ts) |
| GRAPH-01–GRAPH-06, GRAPH-02A–GRAPH-02C | E2E plus integration/unit | [`graph.spec.ts`](../../../frontend/tests/e2e/graph.spec.ts), [`KnowledgeGraphPage.test.tsx`](../../../frontend/src/features/knowledge/pages/KnowledgeGraphPage.test.tsx), [`use-graph-controller.test.tsx`](../../../frontend/src/features/knowledge/graph/hooks/use-graph-controller.test.tsx), [`graph-renderer.test.ts`](../../../frontend/src/features/knowledge/graph/graph-renderer.test.ts), [`GraphCanvas.test.tsx`](../../../frontend/src/features/knowledge/graph/ui/GraphCanvas.test.tsx), [`graph-simulation.test.ts`](../../../frontend/src/features/knowledge/graph/graph-simulation.test.ts) |
| API-01–API-06 | E2E plus integration/unit | [`workspace.spec.ts`](../../../frontend/tests/e2e/workspace.spec.ts), [`chat.spec.ts`](../../../frontend/tests/e2e/chat.spec.ts), [`client.test.ts`](../../../frontend/src/core/api/client.test.ts), [`client-global-failures.test.ts`](../../../frontend/src/core/api/client-global-failures.test.ts), [`auth-api.test.ts`](../../../frontend/src/features/auth/api/auth-api.test.ts), [`workspace-api.test.ts`](../../../frontend/src/features/settings/api/workspace-api.test.ts), [`sse.test.ts`](../../../frontend/src/core/realtime/sse.test.ts) |

Accessibility evidence uses `@axe-core/playwright` on auth, the dashboard shell, knowledge, the settings invitation dialog, chat, and graph. [`auth.spec.ts`](../../../frontend/tests/e2e/auth.spec.ts) and [`workspace.spec.ts`](../../../frontend/tests/e2e/workspace.spec.ts) also cover keyboard-only navigation, focus trapping, and focus restoration without brittle visual snapshots.

The 10 deterministic tests use fixed synthetic UUIDs and `example.invalid` addresses. Playwright also discovers one optional real-backend smoke test, for 11 tests total. In the recorded Task 14 verification environment, the local runner could not bind port 4200, so browser execution remained a CI/root-host gate rather than a claimed local pass. [`real-backend.smoke.spec.ts`](../../../frontend/tests/e2e/real-backend.smoke.spec.ts) runs only when `E2E_REAL_BACKEND_URL` is set; it verifies public health only and does not claim account-backed parity or mutable-data coverage.
...
```bash
rg -n "path:|<Navigate" frontend/src/app/router/router.tsx
rg -n "new EventSource|new WebSocket|fetch\(" frontend/src --glob '*.{ts,tsx}'
...
- [x] Every final React route/redirect maps to a row in `route-parity.md` and at least one stable ID above.
- [x] The final typed API, SSE, and WebSocket operations remain covered by `api-contracts.md`.
...
- [x] Linked automated evidence paths resolve under the final `frontend/` tree.
- [x] The cutover tree contains one supported product frontend, implemented with React and Vite under `frontend/`.

## Final cutover verification context

The checked acceptance items and evidence matrix are cumulative migration records, not a claim that this documentation-only cutover update reran every suite. The supported application and its independently runnable React checks now live under `frontend/`. The former Angular esbuild limitation is retained only as historical context and is no longer a release gate because the Angular product tree is no longer present. Final release verification uses the React commands documented in `frontend/README.md`.
