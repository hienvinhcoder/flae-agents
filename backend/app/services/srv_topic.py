...
from app.services.topic_resolver import slugify
...
class TopicService:
    ...
    async def pre_filter_topics(
        ...
        from app.services.topic_resolver import pre_filter_topics as _pre_filter
    ...
    def resolve_topic_assignments(
        ...
        """
        from app.services.topic_resolver import resolve_topic_assignments as _resolve
