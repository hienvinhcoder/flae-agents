# Prompts cho Graph RAG Ingestion & Retrieval Pipeline

TUPLE_DELIMITER = "<|#|>"
COMPLETION_DELIMITER = "<|COMPLETE|>"

# --- Hướng dẫn cấp hệ thống, xác định vai trò của LLM và tất cả các quy tắc trích xuất ---
...
# --- Hướng dẫn người dùng cho lần trích xuất đầu tiên ---
...
# --- Hướng dẫn người dùng để tiếp tục trích xuất / sửa lỗi (Gleaning) ---
