...
import { LucideAngularModule, LUCIDE_ICONS, LucideIconProvider, Clock, LoaderCircle, CircleCheck, CircleAlert, CircleHelp } from 'lucide-angular';
  ...
  providers: [
    {
      ...
      multi: true,
      useValue: new LucideIconProvider({ Clock, LoaderCircle, CircleCheck, CircleAlert, CircleHelp })
    }
  ],
  template: `
