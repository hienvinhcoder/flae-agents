...
export function TopicCard({ topic }: { topic: Topic }) {
  ...
  return (
    <Link
      className="group flex min-h-56 flex-col rounded-ui-panel border border-ui-line bg-ui-raised p-5 shadow-ui-card transition-colors duration-200 motion-reduce:transition-none hover:border-ui-line-strong focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand"
    ...
    >
      <div className="flex items-start justify-between gap-4">
        ...
        <ArrowUpRight
          aria-hidden
          className="h-5 w-5 shrink-0 text-ui-ink-muted transition-colors duration-200 motion-reduce:transition-none group-hover:text-brand"
        />
      </div>
